...
class InlineConverter
{
    ...
    private static $default_converters = [
        'Logue\LukiWiki\Inline\InlinePlugin',     // Inline plugins
        'Logue\LukiWiki\Inline\Note',             // Footnotes
        'Logue\LukiWiki\Inline\Url',              // URLs
        'Logue\LukiWiki\Inline\InterWiki',        // URLs (interwiki definition)
        'Logue\LukiWiki\Inline\Mailto',           // mailto: URL schemes
        'Logue\LukiWiki\Inline\InterWikiName',    // InterWikiName
        'Logue\LukiWiki\Inline\BracketName',      // BracketName
    //    'Logue\LukiWiki\Inline\WikiName',         // WikiName
        'Logue\LukiWiki\Inline\AutoLink',         // AutoLink
        'Logue\LukiWiki\Inline\Telephone',        // tel: URL schemes
    ];
    /**
     * 変換クラス.
     */
